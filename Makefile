TARGETS = darwin/amd64 darwin/arm64 linux/386 windows/amd64 windows/386
VERSION ?= dev
...
release:
	...
	CC="/usr/bin/aarch64-linux-gnu-gcc" CGO_ENABLED=1 GOOS=linux GOARCH=amd64 GOARM=5 go build -ldflags "$(LDFLAGS)" -o "./bin/cloudgrep_linux_amd64"
